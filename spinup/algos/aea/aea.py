...
import gym
import time
from spinup.algos.aea import core
from spinup.algos.aea.core import get_vars
...
def aea(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
    ...
    step_ops = [pi_loss, q1_loss, q2_loss, v_loss, q1, q2, v, logp_pi, alpha, train_alpha_op,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='aea')
    ...
    aea(lambda: gym.make(args.env), actor_critic=core.mlp_actor_critic,
